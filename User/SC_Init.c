...
void SC_UART1_Init(void)
{
  /*<Generated by EasyCodeCube begin>*/
	...
	/*INT_TX*/UART_ITConfig(UART1,UART_IT_TX,ENABLE);
...
void SC_UART2_Init(void)
{
  /*<Generated by EasyCodeCube begin>*/
	...
	/*INT_TX*/UART_ITConfig(UART2,UART_IT_TX,ENABLE);
...
void SC_DMA0_Init(void)
{
  /*<Generated by EasyCodeCube begin>*/
	...
	DMA_InitStruct.DMA_SrcAddress = (uint32_t)TIM_TI_DMA_SrcData;
	DMA_InitStruct.DMA_DstAddress = (uint32_t)TIM_TI_DMA_DstData;
	DMA_InitStruct.DMA_DataSize = DMA_DataSize_Byte;
	DMA_InitStruct.DMA_Burst = DMA_Burst_Disable;
	DMA_InitStruct.DMA_Request = DMA_Request_TIM2_TI;
