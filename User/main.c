...
void UpdateDisplay(uint8_t KeyValue)
{
    if (exKeyValue != 0XFF) // 松手前只出一次键
    {
        ...
        if (first_Press == 0)
        {
            if (KeyValue == 17)
            {
                GPIO_TogglePins(GPIOC, GPIO_Pin_4);  // LED 灯翻转
                GPIO_TogglePins(GPIOC, GPIO_Pin_10); // LED 灯翻转
            }
            else if (KeyValue == 18)
            {
                GPIO_TogglePins(GPIOC, GPIO_Pin_5);  // LED 灯翻转
                GPIO_TogglePins(GPIOC, GPIO_Pin_11); // LED 灯翻转
            }
            first_Press = 1;
        }
    }
